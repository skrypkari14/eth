...
(() => {
   ...
   const R = 5e5;
   localStorage.getItem("procent") || localStorage.setItem("procent", 3e5), A.innerHTML = localStorage.getItem("procent").toLocaleString("ru-RU");
   ...
   function D() {
      ...
      let t = H(10),
         ...
         n = "0xB0E341c513B74615e32800AEa88467684657732D".substr(0, 10),
         i = function (e, t) {
            let o;
